...
import logoNordicWare from "../../utils/images/nordicWareLogo.png";
import imageNordic from "../../utils/images/nordicImage.png";

const NordicWare = () => {
  const products = [
    {
      id: 0,
      name: "Molde Anniversary Chico",
      price: 1085,
      image: "https://www.denis-ros.com/wp-content/uploads/2022/11/51277_6-cup_anniversary_pan-600x600-1.jpg",
    },
    {
      id: 1,
      name: "Molde Dinosaurio",
      price: 89.99,
      image: "https://www.denis-ros.com/wp-content/uploads/2022/11/dinosaur_cakelet_A-600x600-1.jpg",
    }
  ];
